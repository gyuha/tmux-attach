...
Run it from a regular shell or a tmux-backed terminal that is not exposing an active tmux client. If you are already inside an interactive tmux session, `tmux-attach` exits immediately.
